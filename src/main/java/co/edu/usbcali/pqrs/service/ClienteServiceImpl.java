...
public class ClienteServiceImpl implements ClienteService {
  ...
  public void delete(Cliente entity) throws Exception {
    ...
    try {
      ...
      clienteRepository.deleteById(entity.getClieId());
  ...
  @Override
  @Transactional(readOnly = true)
  public Optional<Cliente> findById(String clieId) throws Exception {
    log.debug("getting Cliente instance");
    return clienteRepository.findById(clieId);
  }
}
