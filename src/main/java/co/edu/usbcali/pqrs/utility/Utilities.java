...
public class Utilities {
  ...
  /**
   * @param word
   * @return Expresion regular "(\\d){1,10}\\.(\\d){1,10}" (\\d)digito {1,10}de 1 a 10 caracteres
   *     \\. punto
   */
  ...
  public static String errorComponentLogic(String lblName, Locale locale) throws Exception {
    InputStream is = null;
    is =
        Utilities.class.getResourceAsStream(
   ...
   * @throws Exception
   */
  public static String errorComponentLogic(String lblName, Locale locale, String... params)
      throws Exception {
    InputStream is = null;
    is =
        Utilities.class.getResourceAsStream(
